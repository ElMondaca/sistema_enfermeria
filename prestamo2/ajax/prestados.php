...
prestamo2.observ_prestamo AS OBSERV, prestamo2.id_prestamo AS IDP
...
AND prestamo2.estado_prestamo = 'Activo'
					...
					<div class="bs-component">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<p>Datos Equipo: <?=$datos->IDE." ".$datos->NEQ." ".$datos->DET?></p>
									...
									<a href="devolucion.php?id=<?=$datos->IDP?>" class="btn btn-success btn-block">Ingresar devolución</a>
								</div>
							</div>
						</div>
<?php
